 ...
 */
public class CheckAuth extends AsyncTask<String, String, String> {

    private String response;
    private List<Cookie> cookies;
    private OnCheckAuthCompleted listener;

    public CheckAuth(OnCheckAuthCompleted l){
    ...
    protected void onPostExecute(String result){
        ...
        if(result.trim().equals("true")){
            listener.OnCheckAuthCompleted(true);
        }
        else{
            listener.OnCheckAuthCompleted(false);
        }
    }
