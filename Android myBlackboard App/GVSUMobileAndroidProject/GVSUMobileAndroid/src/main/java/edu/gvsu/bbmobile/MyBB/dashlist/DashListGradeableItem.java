 ...
 */
public class DashListGradeableItem implements DashListItem {

    public static final int TYPE = BbObjectType.GRADEABLE;
    private String id;
    ...
    public static DashListGradeableItem create(String id, String label, BbContent item ) {
        DashListGradeableItem section = new DashListGradeableItem();
